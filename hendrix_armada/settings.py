...
ALLOWED_HOSTS = ['localhost', '54.205.175.245']
...
STATIC_URL = 'http://54.205.175.245/static/'
MEDIA_URL = 'http://54.205.175.245/images/' # to load media files on admin page as well (changes in url.py file also, project level)
